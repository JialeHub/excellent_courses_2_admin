    ...
    <el-menu
      ...
      <template v-for="firstMenu in menu">
        <el-submenu
            ...
            :key="firstMenu.title + firstMenu.name"
            :index="firstMenu.title"
            class="submenu-title">
          <template slot="title">
            <item :title="$lang(firstMenu.title, firstMenu.name)" :icon="firstMenu.icon"/>
          </template>
          <!-- 二级菜单 -->
          <template v-for="secondMenu in firstMenu.children">
            <el-submenu
                ...
                :key="secondMenu.title + secondMenu.name"
                :index="secondMenu.title"
                class="submenu-title">
              <template slot="title">
                <item :title="$lang(secondMenu.title, secondMenu.name)" :icon="secondMenu.icon"/>
              </template>
              <!-- 三级菜单 -->
              <template v-for="thirdMenu in secondMenu.children">
                <el-menu-item
                    v-show="!thirdMenu.hidden"
                    :key="thirdMenu.title + thirdMenu.name"
                    :index="thirdMenu.title"
                    @click="jump($event, thirdMenu)"
                    class="menu-item">
                  <item :title="$lang(thirdMenu.title, thirdMenu.name)" :icon="thirdMenu.icon"/>
                </el-menu-item>
              </template>
              <!-- 三级菜单 -->
            </el-submenu>
