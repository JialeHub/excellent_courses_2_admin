<template>
  <card ref="Card">
    ...
    <el-table :data="formData">
      ...
      <el-table-column prop="inCity" label="所在城市"/>
      <el-table-column prop="targetCity" label="感兴趣的房产城市"/>
      <el-table-column prop="budget" label="投资预算">
...
<script>
  import {getFormApi, delFormApi} from '@/api/form';
