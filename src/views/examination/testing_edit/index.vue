    ...
    <el-form :model="form" :rules="rules" ref="Form" label-width="5rem">
      ...
      <el-form-item label="题型" prop="chType">
        <el-select v-model="form.chType" placeholder="请选择题型" @change="changeType">
          <el-option label="单选题" :value="0" :disabled="form.chType === 3"/>
          <el-option label="多选题" :value="1" :disabled="form.chType === 3"/>
          <el-option label="判断题" :value="2" :disabled="form.chType === 3"/>
          <el-option label="主观题" :value="3" :disabled="form.chType !== 3"/>
        </el-select>
      </el-form-item>
      <!--客观题题目-->
...
<script>
  ...
  import {updateChoiceApi, updateSubjectApi} from "@/api/examination";
