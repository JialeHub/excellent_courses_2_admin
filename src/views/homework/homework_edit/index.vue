  ...
  <el-dialog
    ...
    <el-form :model="form" :rules="rules" ref="Form" label-width="5rem">
      ...
      <el-form-item label="题目" prop="hwQuestion">
        <custom-editor :editor-key="2" v-model="form.hwQuestion"/>
      </el-form-item>
      <el-form-item label="答案" prop="hwAnswer">
        <custom-editor :editor-key="3" v-model="form.hwAnswer"/>
      </el-form-item>
    </el-form>
...
<script>
  ...
  import { updateHomeworkApi} from "@/api/homework";
