<template>
  <card>
    <go-back :content="title + '资讯'" @back="goBack"/>
    <el-form :model="form" :rules="rules" ref="Form" label-width="100px">
      ...
      <row-col>
        <el-form-item label="封面" prop="cover">
          <image-uploader-plus v-model="form.cover" :width="200" :height="128"/>
        </el-form-item>
        <el-form-item label="附加文件" prop="bazaar">
          <file-uploader v-model="form.fileAddress"/>
        </el-form-item>
      </row-col>
  ...
  export default {
    ...
    data() {
      return {
        ...
        rules: {
          bazaar: {required: false, message: '请上传文件', trigger: 'change'},
